...
<head>
    ...
    <style>
        ...
        body {
            ...
            margin: 0;
            padding: 0;
            background: linear-gradient(to right, whitesmoke, #F4EBD9);
            color: #333;
        }
       ...
       .boys_section{
        ...
        .babies-products .product_container {
            display: grid;
        ...
        .babies-products .product_container .product {
            background: white;
            border-radius: 10px;
            height: 100%;
            width: auto;
        ...
        .babies-products .product_container .product:hover {
            transform: translateY(-5px) scale(1.02);
            box-shadow: 0 15px 30px rgba(0, 0, 0, 0.3);
        }

        .babies-products .product_container .product .image {
            position: relative;
            display: flex;
            justify-content: center;
            align-items: center;
        ...
        .babies-products .product_container .product .image img {
            width: 100%;
            height: 100%;
            object-fit: cover;
        ...
        .babies-products .product_container .product .content {
            padding-top: 0;
            padding: 10px;
        }

        .babies-products .product_container .product .content h3 {
            font-size: 12px;
            margin-bottom: 5px;
        }

        .babies-products .product_container .product .content .price {
            display: inline-block;
            color: #9B8C7E; 
            font-size: 13px;
        }

        .babies-products .product_container .product .content .price del {
            text-decoration: line-through;
            color: #aaa;
        }

        .babies-products .product_container .product .content .rating {
            padding: 10px 0;
            font-size: 10px;
            color: #9B8C7E; 
        }

        .babies-products .product_container .product .content .availability {
            font-size: 10px;
            font-weight: bold;
            margin-bottom: 10px;
        }

        .babies-products .product_container .product .content .fa-shopping-basket,
        .babies-products .product_container .product .content .fa-heart,
        .babies-products .product_container .product .content .fa-eye {
            text-align: center;
            width: 30px;
            height: 30px;
            line-height: 30px;
        ...
        .babies-products .product_container .product .content .fa-shopping-basket:hover,
        .babies-products .product_container .product .content .fa-heart:hover,
        .babies-products .product_container .product .content .fa-eye:hover {
            color: white;
            background: #D8C3A5; 
...
<body style ="overflow-y: auto;">>
    ...
    <!-- Babies' Section -->
    <section class="babies-products" id="product">

         <!-- Baby Girls' Section -->
        <h2 class="girls_section"> Baby Girls' Clothes</h2>

        <div class="product_container">
            <div class="product">
                <div class="image">
                    <img src="images/Girl Baby/formal_pink_dress.jpg.avif" alt="">
                </div>
                <div class="content">
                    <h3>Formal Pink Dress</h3>
                    <div class="price">
            ...
            <div class="product">
                <div class="image">
                    <img src="images/Girl Baby/winter_pink_romper.jpeg" alt="">
                </div>
                <div class="content">
                    <h3>Winter Pink Romper</h3>
                    <div class="price">
            ...
            <div class="product">
                <div class="image">
                    <img src="images/Girl Baby/white_pants.jpeg" alt="">
                </div>
                <div class="content">
                    <h3>White Pants</h3>
                    <div class="price">
            ...
            <div class="product">
                <div class="image">
                    <img src="images/Girl Baby/colourful_overalls.jpeg" alt="">
                </div>
                <div class="content">
                    <h3>Colourful Overalls</h3>
                    <div class="price">
        ...
        <!-- Baby Boys' Section -->
        <h2 class="boys_section">Baby Boys' Clothes</h2>

        <div class="product_container">
            <div class="product">
                <div class="image">
                    <img src="images/Boy Baby/brown_sweater.webp" alt="">
                </div>
                <div class="content">
                    <h3>Brown Sweater</h3>
                    <div class="price">
            ...
            <div class="product">
                <div class="image">
                    <img src="images/Boy Baby/formal_outfit.jpeg" alt="">
                </div>
                <div class="content">
                    <h3>Formal Outfit</h3>
                    <div class="price">
            ...
            <div class="product">
                <div class="image">
                    <img src="images/Boy Baby/khaki_cargo_pants.jpeg" alt="">
                </div>
                <div class="content">
            ...
            <div class="product">
                <div class="image">
                    <img src="images/Boy Baby/blue_sweater_coat.jpeg" alt="">
                </div>
                <div class="content">
                    <h3>Blue Sweater Coat</h3>
                    <div class="price">
